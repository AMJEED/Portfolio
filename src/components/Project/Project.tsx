      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/AMJEED/Ecommerce" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>This eCommerce application is designed to provide a robust platform for online shopping, featuring product listings, user authentication, shopping carts, and order management. The application is built using React.js for the frontend, Node.js with Express for the backend, and Mongoose for managing MongoDB database interactions.
              </p>
            </div>
            <footer> <ul className="tech-list"> <li>Reactjs</li> <li>Nodejs</li> <li> MongoDB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/AMJEED/LMS" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
            ...
            <div className="body">
              <h3>LMS</h3>
              <p>
              The Learning Management System (LMS) is a modern, scalable, platform that provides educators and students with a comprehensive suite of tools to enhance the learning experience,Built using React, Node.js, and MongoDB, this application leverages the strengths of these technologies to deliver a seamless and dynamic user experience. </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3> Code Pan Editor</h3>
              <p>
              The Code Editor application is a web-based tool designed to provide a seamless and interactive environment for writing, editing, and executing code in real-time. Utilizing React for the frontend, alongside HTML, CSS, and JavaScript, this application offers a robust and intuitive code editing experience
